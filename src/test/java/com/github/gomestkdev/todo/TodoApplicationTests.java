...
class TodolistApplicationTests {
	...
	void testCreateTodoSuccess() {
		Todo todo = new Todo(1L, nome: "Test Todo", descricao: "Test Description", concluido: false, prioridade: 1, dataCriacao: LocalDateTime.now());
		...
		webTestClient
				...
				.jsonPath("$.realizado").isEqualTo(todo.isConcluido())
	...
	public void testUpdateTodoSuccess() {
		var todo = new Todo(TODO.getId(), TODO.getNome() + " Up", TODO.getNome() + " Up", !TODO.isConcluido(),
